...
Please reply to the question using only the information present in the text above in this language: {language}.
...
PROMPT = PromptTemplate(template=template, input_variables=["summaries", "question", "language"])
